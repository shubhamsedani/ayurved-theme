...
(function ($) {
    ...
    var imJs = {
        ...
        popupMobileMenu: function (e) {
          ...
          $('.close-menu').on('click', function (e) {
              ...
              $('.popup-mobile-menu .mainmenu .has-droupdown > a, .popup-mobile-menu .mainmenu .with-megamenu > a').siblings('.sub-menu, .rts-megamenu').removeClass('active').slideUp('400');
          ...
          $('.body-mobile .mainmenu .has-droupdown > a, .body-mobile .mainmenu .with-megamenu > a').on('click', function (e) {
              e.preventDefault();
              $(this).siblings('.sub-menu, .rts-megamenu').toggleClass('active');
              $(this).toggleClass('open')
          })
          // nav menu end

          $('.popup-mobile-menu').on('click', function (e) {
              e.target === this && $('.popup-mobile-menu').removeClass('active') && $('.popup-mobile-menu .mainmenu .has-droupdown > a, .popup-mobile-menu .mainmenu .with-megamenu > a').siblings('.sub-menu, .rts-megamenu').removeClass('active').slideUp('400') && $('.popup-mobile-menu .mainmenu .has-droupdown > a, .popup-mobile-menu .mainmenu .with-megamenu > a').removeClass('open');
          });

          $('.one-page-vavigation-popup .mainmenu li > a').on('click' , function (e) {
              e.preventDefault();
              $('.popup-mobile-menu').removeClass('active');
              $('.popup-mobile-menu .mainmenu li > a').siblings('.sub-menu').removeClass('active');
          })
        },
  ...
  jQuery(document).ready(function () {
    jQuery('.certification__slider').slick({
      autoplay: true,
      autoplaySpeed: 2000,
      speed: 800,
      draggable: true,
  ...
  jQuery(document).ready(function($){
    $("body").css("paddingTop", $(".header-one").height() + "px");
